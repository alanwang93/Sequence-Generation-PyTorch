...
class Seq2seq(nn.Module):
    """
    Vanilla seq2seq model with global attention
    """

    def __init__(self, config, data_config, vocab):
        self.config = config 
...
class EncoderRNN(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size, n_layers=1, padding_idx=0):
